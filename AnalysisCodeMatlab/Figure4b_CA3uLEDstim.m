...
%%
sessnum = 40:45;
figureName = 'Figure4b_CA3uLEDstim.pdf';
statName = 'Figure4b_CA3uLEDstim_deltaFR.xls';
propName = 'Figure4b_CA3uLEDstim_proportions.xls';
...
for n = 1:length(vpout)
    ...
    text(n,min(ylim)+Prngns/4,5,num2str(length(vpout(n).ScatterPlot.XData)),'fontsize',5,'HorizontalAlignment','center', ...
...
print(gcf,'-painters', '-dpdf',['C:/Users/Watkinsdejong/OneDrive/Documents/MATLAB/GenerateFigs/PDFfigs/',figureName]);
%%
close 
clear