...
%%
sessnum = 46:50;
figureName = 'Figure5a_CA1AllFiberGAD_null.pdf';
statName = 'Figure5a_CA1AllFiberGAD_deltaFR_null.xls';
propName = 'Figure5a_CA1AllFiberGAD_proportions_null.xls';
fStatName = 'Figure5a_CA1AllFiberGAD_ftest_null.xls';
%% delta FR
sessionID = [];
stimShank =[];
cellShank = [];
