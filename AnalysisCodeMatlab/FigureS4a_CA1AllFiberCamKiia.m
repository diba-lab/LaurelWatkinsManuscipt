...
%%
sessnum = 63:66;
figureName = 'FigureS4a_CA1AllFiberCamKiia.pdf';
statName = 'FigureS4a_CA1AllFiberCamKiia_deltaFR.xls';
propName = 'FigureS4a_CA1AllFiberCamKiia_proportions.xls';
...
for i = 1:length(pyramidal.intensity)
    ...
    elseif pyramidal.intensity(i) == 200 || pyramidal.intensity(i) == 215
        pyramidal.intensity(i) = 210;
    elseif pyramidal.intensity(i) == 235
        pyramidal.intensity(i) = 230;
    elseif pyramidal.intensity(i) == 245
        pyramidal.intensity(i) = 250;
    end
end
%%
for i = 1:length(interneuron.intensity)
    if interneuron.intensity(i) == 155
    ...
    elseif interneuron.intensity(i) == 200 || interneuron.intensity(i) == 215
        interneuron.intensity(i) = 210;
    elseif interneuron.intensity(i) == 235
        interneuron.intensity(i) = 230;
    elseif interneuron.intensity(i) == 245
...
%% make pvalue table
laserIntensity = [.001 .05 .1 .15 .2 .25 .3]';
