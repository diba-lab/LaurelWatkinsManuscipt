...
%%
sessnum = 26:31;
figureName = 'Figure3b_CA3uLEDsilence_null.pdf';
statName = 'Figure3b_CA3uLEDsilence_deltaFR_null.xls';
propName = 'Figure3b_CA3uLEDsilence_proportions_null.xls';
fStatName = 'Figure3b_CA3uLEDsilence_ftest_null.xls';
%% delta FR
sessionID = [];
cellShank = [];
stimShank = [];
