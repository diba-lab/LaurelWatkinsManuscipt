...
%%
sessnum = 56:62;
figureName = 'Figure6a_CA3CA1Acute.pdf';
statName = 'Figure6a_CA3CA1Acute.xls';
propName = 'Figure6a_CA3CA1Acute_proportions.xls';
...
%%
vPlotratID = {'All' 'RatDD' 'RatDF' 'RatDG' 'RatDH'};
