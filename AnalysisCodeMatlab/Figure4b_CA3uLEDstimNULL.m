...
%%
sessnum = 40:45;
figureName = 'Figure4b_CA3LEDstim_null.pdf';
statName = 'Figure4b_CA3LEDstim_deltaFR_null.xls';
propName = 'Figure4b_CA3LEDstim_proportions_null.xls';
fStatName = 'Figure4b_CA3LEDstim_ftest_null.xls';
%% delta FR
sessionID = [];
cellShank = [];
stimShank = [];
