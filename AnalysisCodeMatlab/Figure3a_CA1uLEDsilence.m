...
%%
sessnum = 19:25;
figureName = 'Figure3a_CA1uLEDsilence.pdf';
statName = 'Figure3a_CA1uLEDsilence_deltaFR.xls';
propName = 'Figure3a_CA1uLEDsilence_proportions.xls';
...
%text(5,max(ylim),num2str(wintFR),'fontsize',5,'horizontalalignment','right','verticalalignment','top')
xlim([0 5])
ax = gca; 
ax.XAxis.FontSize = 7;
ax.YAxis.FontSize = 7;
